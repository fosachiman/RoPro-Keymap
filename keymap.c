...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | PgDn | Del  | Ctrl | Alt  | Cmd  |Lower | TAB  |SPACE | Raise| Left | Down |  Up  |Right |
   * `------------------------------------------------------------------------------------------'
   */
  	[_BASE] = LAYOUT(
    ...
    KC_PGDN,  KC_DEL,    KC_RCTRL, KC_LALT,  KC_LCMD,  LOWER,    KC_TAB,   KC_SPC,   RAISE,   KC_LEFT,  KC_DOWN,   KC_UP,    KC_RGHT
  ),
